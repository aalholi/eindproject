...
<html lang="en">
  ...
  <body>
        ...
        <main>
          <section id="hero">
            <div class="img">
              <img width="300px" src="images/home/brownie-with-ai-generated-free-png 1.png" alt="hero - image">
            </div>
            <h2>Welcome To --</h2> 
            <h1>Brawnies </h1>
            <h1>Escape Rooms</h1>
          ...
          <section id="about">
            <p>Experience the thrill of solving puzzles and escaping rom challenging rooms.</p>
          </section>
          ...
          <section id="liverooms">
            <h2>Live Rooms</h2>
            <!-- Flicker -->
            <div class="carousel" id="carousel" data-flickity='{"autoPlay":true}'>
              <div class="carousel-cell" style="background-image: url(images/home/lawrence-chismorie-o2ZIh9Bqjtc-unsplash\ 1.png);">
              </div>
              <div class="carousel-cell" style="background-image: url(images/home/peter-herrmann-bhF8gu9DaU4-unsplash\ 1.png);">
              </div>
              <div class="carousel-cell" style="background-image: url(images/home/marina-reich-qC1JcYEOOv8-unsplash\ 1.png);">
              </div>
            </div>
            
            <p>Explore our captivating rooms and secure your reservation for an enhanced escape room experience. Whether you're seeking the thrill of live adventures or the convenience of online challenges, we've got you covered!</p>
            <a class="learnMore" href="./pages/games.php">Learn More</a>
          </section>
        </main>
      <footer>
        <div class="row">
